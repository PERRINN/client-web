...
@Component({
  ...
  <div class='sheet'>
    <div *ngIf="scope.substring(0,7)=='channel'&&scope!='listChannels'" style="clear:both;background:whitesmoke">
      <img *ngIf="UI.currentChannelLastMessageObj?.channelImageUrlMedium" [src]="UI.currentChannelLastMessageObj?.channelImageUrlMedium" style="margin:5px;object-fit:cover;border-radius:3px;height:75px;width:300px">
