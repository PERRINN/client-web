...
@Component({
  ...
  <img class="imageWithZoom" [src]="UI.currentUserLastMessageObj?.imageUrlMedium||UI.currentUserLastMessageObj?.imageUrlThumbUser" style="object-fit:cover;margin:10px;height:200px;width:200px" (click)="showFullScreenImage(UI.currentUserLastMessageObj?.imageUrlOriginal)"
