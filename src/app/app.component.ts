  ...
  template: `
    ...
    <div style="user-select:none">
      <div style="max-width:800px;margin:0 auto">
        <button *ngIf="!UI.currentUser" class="buttonWhite" style="float:left;line-height:20px;width:75px;margin:7px" (click)="router.navigate(['login'])" [disabled]='this.router.url.startsWith("/login")'>Login</button>
