  ...
  template: `
    ...
    <div style="user-select:none">
      <div *ngIf="UI.currentUser" style="max-width:800px;margin:0 auto">
        ...
        <div style="float:left;font-size:10px;text-align:center;line-height:15px;width:75px;padding:2px;margin:8px;color:white;background-color:midnightblue;border-radius:3px;cursor:pointer" (click)="router.navigate(['join'])">membership</div>
